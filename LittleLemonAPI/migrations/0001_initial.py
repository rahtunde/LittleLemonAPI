    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(db_index=True, decimal_places=2, max_digits=6)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('munuitem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='LittleLemonAPI.menuitem')),
            ],
            options={
                'unique_together': {('munuitem', 'user')},
            },
        ),
        migrations.CreateModel(
            name='OrderItem',
            ...
            options={
                'unique_together': {('order', 'munuitem')},
            },
        ),
    ]
